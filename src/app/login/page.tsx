...
export default async function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col lg:grid lg:grid-cols-2 bg-background">
      ...
      <div className="flex flex-col justify-center p-8 lg:p-16 bg-[#FFE600] lg:border-r-4 border-b-4 lg:border-b-0 border-black relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 p-8 opacity-20 pointer-events-none hidden lg:block">
          <svg width="150" height="150" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
             <rect x="20" y="20" width="60" height="60" stroke="black" strokeWidth="8" strokeDasharray="10 10" />
          </svg>
        </div>
        ...
        <div className="relative z-10 max-w-lg mx-auto lg:mx-0 text-center lg:text-left mt-8 lg:mt-0">
          <h1 className="text-4xl lg:text-6xl font-black tracking-tighter leading-tight mb-4 text-black">
            Invoice Like a Pro. <br className="hidden lg:block" /> Get Paid Faster.
          </h1>
          <p className="text-lg lg:text-xl font-bold text-black/80 mt-4 max-w-md mx-auto lg:mx-0">
            Log in to manage your invoices and clients without the BS.
          </p>
